...
public class AddEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repeat = findViewById(R.id.EventOccurance);
        ...
        declineButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (databaseHelper.insertEvent(eventTitle.getText().toString(),
    ...
    public void createDialog() {
        ...
        dialog.show();
        d = dialog.findViewById(R.id.daily);
        w = dialog.findViewById(R.id.weekly);
        m = dialog.findViewById(R.id.monthly);
        y = dialog.findViewById(R.id.yearly);
    ...
    //  Algorithm to show time and to format correct AM OR PM
